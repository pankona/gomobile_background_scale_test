...
func loadScene() {
	...
	sprite_x := float32(0) // sprite x position
	sprite_y := float32(0) // sprite y position
	...
	n.Arranger = arrangerFunc(func(eng sprite.Engine, n *sprite.Node, t clock.Time) {
		...
		// scale to fit screen
		simpleScale(affine, sprite_w*scaleFactor, sprite_h*scaleFactor)
...
func simpleScale(affine *f32.Affine, w, h float32) {
	affine.Scale(affine, w, h)
}
